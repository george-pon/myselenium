...
def browser_fetch(url, verbose, screenshot, fullscreenshot, cmdscreenshot, waitsec):
...
if __name__ == '__main__':
    ...
    browser_fetch( url=args.url , verbose=args.verbose, screenshot=args.screenshot, cmdscreenshot=args.cmdscreenshot, fullscreenshot=args.fullscreenshot, waitsec=args.waitsec)
